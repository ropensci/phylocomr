...
`phylocomr` gives you access to the [Phylocom C library](https://github.com/phylocom/phylocom/), licensed under [BSD 2-clause](https://www.opensource.org/licenses/bsd-license.php)
