...
[![cran checks](https://cranchecks.info/badges/worst/phylocomr)](https://cloud.r-project.org/web/checks/check_results_phylocomr.html)
...
`phylocomr` gives you access to the [Phylocom C library](https://github.com/phylocom/phylocom/), licensed under [BSD 2-clause](https://opensource.org/licenses/bsd-license.php)
