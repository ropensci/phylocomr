...
use various different references trees
    ...
    #> attr(,"taxa_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/taxa_b5f11306c569"
    #> attr(,"phylo_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/phylo_b5f1218a7a41"
    ...
    #> attr(,"taxa_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/taxa_b5f1a60529b"
    #> attr(,"phylo_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/phylo_b5f139cf436f"
    ...
    #> attr(,"taxa_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/taxa_b5f137ca4b10"
    #> attr(,"phylo_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/phylo_b5f14206240d"

    ph_phylomatic(taxa = taxa_str, phylo = zanne_subtree_file)

    #> [1] "((neuburgia_corynocarpum:32.807743,(geniostoma_borbonicum:32.036335,strychnos_darienensis:32.036335):0.771406):1.635496)loganiaceae:0.000000;\n"
    #> attr(,"taxa_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/taxa_b5f12128f358"
    #> attr(,"phylo_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/phylo_b5f1780276a"
...
## aot
    ...
    #>  2     1 traitA        1 b         4    16       2   1.75     636     662  0.447
    #>  3     1 traitA        2 c         3     8       2   1.75     668     684  0.463
    #>  4     1 traitA        3 d         2     4       2   1.5      257     955  0.577
    #>  5     1 traitA        4 e         1     2       2   1         64    1000  0    
    #>  6     1 traitA        7 f         1     2       2   2       1000     556  0    
    #>  7     1 traitA       10 g         2     4       2   2       1000     289  0    
    #>  8     1 traitA       11 h         1     2       2   2       1000     547  0    
    #>  9     1 traitA       14 i         1     2       2   2       1000     555  0    
    #> 10     1 traitA       17 j         3     8       2   1.75     655     698  0.463
...
## bladj
    ...
    #> attr(,"ages_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/ages"
    #> attr(,"phylo_file")
    #> [1] "/var/folders/ss/2tpkp325521_kfgn59g44vd80000gn/T//Rtmp7QKKhJ/phylo_b5f12289c894"
